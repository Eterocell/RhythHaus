...
| P1 | First-run onboarding | Planning complete: OpenSpec capability, technical design, task ledger, and executable TDD plan are ready. | Review and apply [`first-run-onboarding`](openspec/changes/first-run-onboarding/) using [`2026-09-11-first-run-onboarding.md`](docs/superpowers/plans/2026-09-11-first-run-onboarding.md). |
