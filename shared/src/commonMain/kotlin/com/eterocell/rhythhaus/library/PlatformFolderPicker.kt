 ...
 *
 * The application shell composes this seam from the Shared facade. Android
 * and JVM actuals delegate to the library feature implementations; the iOS
 * actual launches the retained Swift Files.app import provider declared next
 * to this expect in the Shared framework ABI (see `IOSLibraryImport.kt`).
 *
