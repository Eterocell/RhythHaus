...
actual fun ByteArray.decodeArtwork(): ImageBitmap? =
    try {
...
actual fun ByteArray.decodeArtworkThumbnail(maxPixelSize: Int): ImageBitmap? =
    try {
        ...
        val thumbnail =
            if (sampled.width == scaledWidth &&
                sampled.height == scaledHeight) {
                sampled
            } else {
