...
class PlaylistBackupCodecTest {
                ...
                playlists =
                    listOf(
                        PlaylistBackupPlaylist(
                            "Mix", listOf(duplicateEntry, duplicateEntry)),
                    ),
            )

        val payloadJson =
            "{\"format\":\"rhythhaus-playlist-backup\",\"version\":1,\"exportedAtEpochMillis\":1725000000123," +
                "\"playlists\":[{\"name\":\"Mix\",\"entries\":[" +
                "{\"title\":\"A \\\"quoted\\\" title\\n\",\"artist\":\"Bjork \uD83C\uDFB5\",\"album\":\"tab\\tand\\\\slash\",\"durationSeconds\":245}," +
                "{\"title\":\"A \\\"quoted\\\" title\\n\",\"artist\":\"Bjork \uD83C\uDFB5\",\"album\":\"tab\\tand\\\\slash\",\"durationSeconds\":245}]}]}"
        val expected =
            payloadJson.dropLast(1) +
                ",\"checksumCrc32\":\"${Crc32.hex(payloadJson.encodeToByteArray())}\"}"

        assertContentEquals(
            expected.encodeToByteArray(), PlaylistBackupCodec.encode(payload))
    }
    ...
    fun roundTripPreservesPlaylistOrderEntryOrderAndDuplicates() {
        val payload =
            PlaylistBackupPayload(
                ...
                playlists =
                    listOf(
                        PlaylistBackupPlaylist(
                            "Second", listOf(duplicateEntry, duplicateEntry)),
        ...
        val document =
            assertIs<PlaylistBackupDecodeResult.Success>(
                    PlaylistBackupCodec.decode(
                        PlaylistBackupCodec.encode(payload)),
                )
                .document
        ...
        assertEquals(
            payload.exportedAtEpochMillis, document.exportedAtEpochMillis)
    ...
    fun malformedJsonAndUnpairedEscapedSurrogatesAreRejected() {
        assertInvalid(
            "{".encodeToByteArray(),
            PlaylistBackupValidationError.MALFORMED_JSON)
        assertInvalid(
            document(entryTitle = "\\uD800"),
            PlaylistBackupValidationError.MALFORMED_JSON)
        assertInvalid(
    ...
    fun duplicateFieldsAreRejectedAtEveryObjectLevel() {
        assertInvalid(
            checksummed(
                "{\"format\":\"rhythhaus-playlist-backup\",\"format\":\"rhythhaus-playlist-backup\",\"version\":1,\"exportedAtEpochMillis\":0,\"playlists\":[]}"),
            PlaylistBackupValidationError.DUPLICATE_FIELD,
        )
        assertInvalid(
            document(playlistPrefix = "\"name\":\"Again\","),
            PlaylistBackupValidationError.DUPLICATE_FIELD)
        assertInvalid(
            document(entryPrefix = "\"title\":\"Again\","),
            PlaylistBackupValidationError.DUPLICATE_FIELD)
    }
    ...
    fun unknownFieldsAreRejectedAtEveryObjectLevel() {
        assertInvalid(
            document(rootPrefix = "\"extra\":0,"),
            PlaylistBackupValidationError.UNKNOWN_FIELD)
        assertInvalid(
            document(playlistPrefix = "\"extra\":0,"),
            PlaylistBackupValidationError.UNKNOWN_FIELD)
        assertInvalid(
            document(entryPrefix = "\"extra\":0,"),
            PlaylistBackupValidationError.UNKNOWN_FIELD)
    }
    ...
    fun missingFieldsAreRejectedAtEveryObjectLevel() {
        assertInvalid(
            checksummed(
                "{\"version\":1,\"exportedAtEpochMillis\":0,\"playlists\":[]}"),
            PlaylistBackupValidationError.MISSING_FIELD)
        assertInvalid(
            checksummed(
                "{\"format\":\"rhythhaus-playlist-backup\",\"version\":1,\"exportedAtEpochMillis\":0,\"playlists\":[{\"entries\":[]}]}"),
            PlaylistBackupValidationError.MISSING_FIELD,
        )
        assertInvalid(
            checksummed(
                "{\"format\":\"rhythhaus-playlist-backup\",\"version\":1,\"exportedAtEpochMillis\":0,\"playlists\":[{\"name\":\"P\",\"entries\":[{\"artist\":\"A\",\"album\":\"B\",\"durationSeconds\":1}]}]}"),
            PlaylistBackupValidationError.MISSING_FIELD,
        )
    }
    ...
    fun unsupportedFormatVersionAndBadChecksumAreTypedFailures() {
        ...
        assertInvalid(
            document()
                .decodeToString()
                .replace(Regex("[0-9a-f]{8}(?=\"})"), "00000000")
                .encodeToByteArray(),
            PlaylistBackupValidationError.INVALID_CHECKSUM)
        assertInvalid(
            document()
                .decodeToString()
                .replace(Regex("[0-9a-f]{8}(?=\"})"), "ABCDEF12")
                .encodeToByteArray(),
            PlaylistBackupValidationError.INVALID_CHECKSUM)
        assertInvalid(
            withChecksum("1234567"),
            PlaylistBackupValidationError.INVALID_CHECKSUM)
        assertInvalid(
            withChecksum("gggggggg"),
            PlaylistBackupValidationError.INVALID_CHECKSUM)
        assertInvalid(
            withChecksum("1234567-"),
            PlaylistBackupValidationError.INVALID_CHECKSUM)
    ...
    fun numbersMustBePlainIntegersWithinLongRange() {
        listOf("1.0", "1e0", "+1", "01").forEach {
            assertInvalid(
                document(version = it),
                PlaylistBackupValidationError.INVALID_INTEGER)
        }
        assertInvalid(
            document(version = "١"),
            PlaylistBackupValidationError.INVALID_INTEGER)
        assertInvalid(
            ...
            PlaylistBackupValidationError.INVALID_INTEGER)
        assertInvalid(
            document(exportedAt = "9223372036854775808"),
            PlaylistBackupValidationError.NUMERIC_OVERFLOW)
        assertInvalid(
            document(duration = "999999999999999999999"),
            PlaylistBackupValidationError.NUMERIC_OVERFLOW)
    }
    ...
    fun trailingContentIsRejected() {
        assertInvalid(
            document() + " true".encodeToByteArray(),
            PlaylistBackupValidationError.TRAILING_CONTENT)
    }
    ...
    fun nonCanonicalKeyOrderAndWhitespaceAreRejected() {
        assertInvalid(
            checksummed(
                "{\"version\":1,\"format\":\"rhythhaus-playlist-backup\",\"exportedAtEpochMillis\":0,\"playlists\":[]}"),
            PlaylistBackupValidationError.NON_CANONICAL_JSON,
        )
        assertInvalid(
            checksummed(
                "{\"format\":\"rhythhaus-playlist-backup\",\"version\":1,\"exportedAtEpochMillis\":0,\"playlists\":[{\"entries\":[],\"name\":\"P\"}]}"),
            PlaylistBackupValidationError.NON_CANONICAL_JSON,
        )
        assertInvalid(
            checksummed(
                "{\"format\":\"rhythhaus-playlist-backup\",\"version\":1,\"exportedAtEpochMillis\":0,\"playlists\":[{\"name\":\"P\",\"entries\":[{\"artist\":\"A\",\"title\":\"T\",\"album\":\"B\",\"durationSeconds\":1}]}]}"),
            PlaylistBackupValidationError.NON_CANONICAL_JSON,
        )
        assertInvalid(
            checksummed(
                "{ \"format\":\"rhythhaus-playlist-backup\",\"version\":1,\"exportedAtEpochMillis\":0,\"playlists\":[]}"),
            PlaylistBackupValidationError.NON_CANONICAL_JSON,
        )
    }
    ...
    fun alternateJsonEscapesAreRejectedThroughPublicDecode() {
        listOf(
            ...
            .forEach { encodedTitle ->
                assertInvalid(
                    document(entryTitle = encodedTitle),
                    PlaylistBackupValidationError.NON_CANONICAL_JSON)
            }
    }
    ...
    fun durationBoundsAreInclusiveAndExactLimitPlusOneIsRejected() {
        assertIs<PlaylistBackupDecodeResult.Success>(
            PlaylistBackupCodec.decode(document(duration = "0")))
        assertIs<PlaylistBackupDecodeResult.Success>(
            PlaylistBackupCodec.decode(document(duration = "604800")))
        assertInvalid(
            document(duration = "-1"),
            PlaylistBackupValidationError.INVALID_DURATION)
        assertInvalid(
            document(duration = "604801"),
            PlaylistBackupValidationError.INVALID_DURATION)
    }
    ...
    fun stringCodePointLimitHandlesSupplementaryCharactersAndRejectsPlusOne() {
        ...
        assertIs<PlaylistBackupDecodeResult.Success>(
            PlaylistBackupCodec.decode(document(entryTitle = exact)))
        assertInvalid(
            document(entryTitle = exact + "x"),
    ...
    fun playlistCountLimitAcceptsExactAndRejectsPlusOne() {
        assertIs<PlaylistBackupDecodeResult.Success>(
            PlaylistBackupCodec.decode(document(playlists = playlists(1_000))))
        assertInvalid(
            document(playlists = playlists(1_001)),
    ...
    fun perPlaylistEntryLimitAcceptsExactAndRejectsPlusOne() {
        assertIs<PlaylistBackupDecodeResult.Success>(
            PlaylistBackupCodec.decode(document(entries = entries(10_000))))
        assertInvalid(
            document(entries = entries(10_001)),
    ...
    fun totalEntryLimitAcceptsExactAndRejectsPlusOne() {
        val exact =
            checksummed(documentText(playlists = playlists(10, 10_000)))
                .decodeToString()
        assertEquals(
            100_000,
            StrictJsonParser(exact).parse().document.playlists.sumOf {
                it.entries.size
            })
        assertEquals(
    ...
    fun encodeRejectsStructurallyValidPayloadBeyondByteLimit() {
        ...
        assertFailsWith<IllegalArgumentException> {
            PlaylistBackupCodec.encode(oversized)
        }
    }
    ...
    fun encodeEnforcesStringCodePointBounds() {
        ...
        PlaylistBackupCodec.encode(
            PlaylistBackupPayload(0, listOf(playlist(name = exact))))
        PlaylistBackupCodec.encode(
            PlaylistBackupPayload(
                0, listOf(playlist(entry = entry(title = exact)))))
    ...
    fun encodeEnforcesPlaylistAndPerPlaylistEntryBounds() {
        PlaylistBackupCodec.encode(
            PlaylistBackupPayload(
                0, List(1_000) { PlaylistBackupPlaylist("P", emptyList()) }),
        )
        assertEncodeInvalid(
            List(1_001) { PlaylistBackupPlaylist("P", emptyList()) })

        val exactEntries = List(10_000) { entry(title = "") }
        PlaylistBackupCodec.encode(
            PlaylistBackupPayload(
                0, listOf(PlaylistBackupPlaylist("P", exactEntries))))
        assertEncodeInvalid(
            PlaylistBackupPlaylist("P", exactEntries + entry(title = "")))
    }
    ...
    fun encodeEnforcesReachableTotalEntryBranches() {
        ...
        assertEncodeInvalid(
            exactTotal + PlaylistBackupPlaylist("P", listOf(entry(title = ""))))
    }
    ...
    fun encodeEnforcesDurationBounds() {
        PlaylistBackupCodec.encode(
            PlaylistBackupPayload(
                0, listOf(playlist(entry = entry(duration = 0)))))
        PlaylistBackupCodec.encode(
            PlaylistBackupPayload(
                0, listOf(playlist(entry = entry(duration = 604_800)))))
    ...
    private fun documentText(
        ...
        val encodedEntries =
            entries
                ?: "[{${entryPrefix}\"title\":\"$entryTitle\",\"artist\":\"A\",\"album\":\"B\",\"durationSeconds\":$duration}]"
        val encodedPlaylists =
            playlists
                ?: "[{${playlistPrefix}\"name\":\"$playlistName\",\"entries\":$encodedEntries}]"
    ...
    private fun checksummed(payloadJson: String): ByteArray {
        ...
        return (payloadJson.dropLast(1) + ",\"checksumCrc32\":\"$checksum\"}")
            .encodeToByteArray()
    }

    private fun withChecksum(checksum: String): ByteArray {
        val payload = documentText()
        return (payload.dropLast(1) + ",\"checksumCrc32\":\"$checksum\"}")
            .encodeToByteArray()
    }
    ...
    private fun entry(
        title: String = "T",
        duration: Int = 1
    ): PlaylistBackupEntry = PlaylistBackupEntry(title, "A", "B", duration)
    ...
    private fun assertInvalid(
        bytes: ByteArray,
        expected: PlaylistBackupValidationError
    ) {
        assertEquals(
