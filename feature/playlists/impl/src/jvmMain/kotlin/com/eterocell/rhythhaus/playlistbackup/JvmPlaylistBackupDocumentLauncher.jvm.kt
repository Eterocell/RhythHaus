...
/**
 * Remembers the JVM file-dialog launcher and routes each terminal outcome to
 * Shared.
 *
 * The returned launcher normalizes the selected backup filename and applies the
 * neutral 4 MiB open bound before delivering a feature result.
 */
@Composable
public fun rememberJvmPlaylistBackupDocumentLauncher(
