...
/**
 * Remembers the Android document launcher and routes each platform terminal
 * callback to Shared.
 *
 * The returned launcher preserves Android's single active panel behavior and
 * applies the neutral 4 MiB open bound before delivering a feature result.
 */
@Composable
public fun rememberAndroidPlaylistBackupDocumentLauncher(
