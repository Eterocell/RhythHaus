...
internal enum class PlaylistBackupExportError {
    MISSING_TRACK,
    MISSING_DURATION,
    INVALID_DURATION,
    CODEC_BOUNDS,
...
internal sealed interface PlaylistBackupExportResult {
...
internal data class PlaylistImportCounts(
    val restorable: Int,
    val unmatched: Int,
    val ambiguous: Int,
) {
...
internal data class PlaylistImportPlaylist(
    val sourcePlaylistIndex: Int,
    val name: String,
    val trackIds: List<String>,
)

internal data class PlaylistImportPlaylistReport(
    val sourcePlaylistIndex: Int,
...
internal enum class PlaylistImportIssueKind {
    UNMATCHED,
    AMBIGUOUS
}

internal data class PlaylistImportIssue(
...
internal data class PlaylistImportTotals(
...
internal fun exportPlaylistBackup(
