...
internal data class PlaylistBackupPayload(
...
internal data class PlaylistBackupPlaylist(
    val name: String,
    val entries: List<PlaylistBackupEntry>,
)

internal data class PlaylistBackupEntry(
    val title: String,
    val artist: String,
    val album: String,
...
internal sealed interface PlaylistBackupDecodeResult {
