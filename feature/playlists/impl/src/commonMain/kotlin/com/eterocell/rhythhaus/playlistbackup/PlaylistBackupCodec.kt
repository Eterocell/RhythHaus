...
internal object PlaylistBackupCodec {
    const val FORMAT = "rhythhaus-playlist-backup"
    const val VERSION = 1

    internal fun encode(payload: PlaylistBackupPayload): ByteArray {
    ...
    internal fun decode(bytes: ByteArray): PlaylistBackupDecodeResult {
